...
HD_PWD='C:/Assignment_04/Assignment_04.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Binary_Multiplier.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Binary_Multiplier.tcl -notrace
