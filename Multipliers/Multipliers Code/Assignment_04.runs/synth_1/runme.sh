...
HD_PWD='C:/Assignment_04/Assignment_04.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Binary_Multiplier.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Binary_Multiplier.tcl
