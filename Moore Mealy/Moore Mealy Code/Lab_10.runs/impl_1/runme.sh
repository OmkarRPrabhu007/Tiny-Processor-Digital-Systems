...
HD_PWD='C:/Users/OmkarRPrabhu/Lab_10/Lab_10.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Mealy_10010.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Mealy_10010.tcl -notrace
