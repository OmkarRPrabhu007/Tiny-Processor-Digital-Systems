...
HD_PWD='C:/Users/OmkarRPrabhu/Lab_10/Lab_10.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mealy_10010.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mealy_10010.tcl
